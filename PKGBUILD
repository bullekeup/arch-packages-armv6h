...
pkgbase=opencv
pkgname=('opencv-gstreamer-rpi' 'opencv-gstreamer-rpi-samples')
pkgver=3.2.0
pkgrel=1
...
license=('BSD')
url="http://opencv.org/"
depends=('openexr' 'xine-lib' 'libdc1394' 'gtkglext' 'gstreamer' 'gst-libav' 'ffmpeg' 'libx264' 'x264' 'gdal' 'libgphoto2' 'hdf5-cpp-fortran' 'python-h5py' 'python2-h5py' 'protobuf' 'google-glog' 'doxygen' 'cpio' 'lzop' 'p7zip' 'unrar' 'unzip' 'zip')
